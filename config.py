# config.py (à ne pas versionner)
# Placez ici vos variables sensibles et de configuration

BASE_URL = "qualysapi.qualys.eu"
USERNAME = "wha-ep2"
PASSWORD = "c4XFr:wH5tHB!!"
...
# Configurations de rapports pour les scans (PDF/CSV)
REPORT_CONFIGS = [
    {
...
Username        JWSP1678
Domain          ad.francetelecom.fr
Password        GxEI6"ELN4?c
